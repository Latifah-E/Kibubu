            ...
            VStack(spacing: 15){
                HStack{
                    Image(systemName: "person")
                        .foregroundColor(fname.isEmpty ? Color("login") :  Color("teal"))
                        .font(Font.custom("Poppins-Light", size: 18 ))
                        .padding(.leading, 10)
                    TextField("", text: $fname)
                        .padding(.leading, 0)
                        .placeholder(when: fname.isEmpty) {
                            Text("Full Name").opacity(0.3)
                        }
                        .padding(15)
                    ...
                    .overlay(
                                RoundedRectangle(cornerRadius: 10)
                                    .stroke(fname.isEmpty ? Color("walkthrough").opacity(0.8) : Color("teal"), lineWidth: 0.5)
                            )
                HStack{
